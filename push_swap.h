...
//CURRENTLY USING THE CHECKER, THERES A FEW ISSUES, MEMORY ISSUES (FREES BEING CALLED
//WHEN THEY SHOULDNT), WHEN THE ARG IS MADE UP OF THE SAME NUMBER, WHEN THE ARGS ARE
//ALREADY ORDERED, WHEN THE ARGS ARE INVALID "E4" AND MAYBE MORE. SEEMS TO BE ERROR CHECKING THINGS.
//WHEN MULTIPLE "" "" "" ARE PASSED, CHECKER SAYS OK, HOWEVER MIGHT HAVE MEMORY ISSUES
//NEED MORE TESTING, VALGRIND ETC.
